...
Consistency & Standards | Some menu options create submenus while others do not and select options that do not mirror the extensive menu hidden within the menu icon | A single menu on top without submenus avoid confusions as well as the hidden menu trees on the left
